...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("VBK Core VBK-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  VBK-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded VBK transaction") + "\n" +
                               "  VBK-tx [options] -create [commands]   " + _("Create hex-encoded VBK transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded VBK transaction
