                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received VBK from zVBK"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zVBK"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zVBK));
