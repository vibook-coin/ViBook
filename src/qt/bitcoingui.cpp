                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("VBK Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a VBK address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and VBK: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zVBK"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About VBK Core"), this);
    aboutAction->setStatusTip(tr("Show information about VBK Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for VBK"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your VBK addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified VBK addresses"));
    ...
    openAction->setStatusTip(tr("Open a VBK: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the VBK Core help message to get a list with possible VBK command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("VBK Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to VBK network", "", count));
}
...
{
    QString strTitle = tr("VBK Core"); // default title
...
/** Creates context menu, its actions, and VBKs up all the relevant signals for mouse events. */
