...
#define DEV_FEE_BLOCK_ACTIVATION 1440 // roughly 14:00 UTC 17th of June 2019
...
/*    } else {
		if (!fProofOfStake)
			txNew.vout[0].nValue = blockValue - masternodePayments;
*/	} //PERHAPS DELETE THREE LINES ABOVE THIS
}
...
bool CMasternodeBlockPayees::IsTransactionValid(const CTransaction& txNew)
{
	...
	if(foundDevFee)
		...
		LogPrintf("CMasternodePayments::IsTransactionValid - Missing developerfee of %s\n", FormatMoney(requiredDeveloperPayment).c_str()); // PERHAPS ADD ["masternode",] BEFORE ["CMaster..]
