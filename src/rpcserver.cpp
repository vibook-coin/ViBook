...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* VBK features */
        {"VBK", "masternode", &masternode, true, true, false},
        {"VBK", "listmasternodes", &listmasternodes, true, true, false},
        {"VBK", "getmasternodecount", &getmasternodecount, true, true, false},
        {"VBK", "masternodeconnect", &masternodeconnect, true, true, false},
        {"VBK", "masternodecurrent", &masternodecurrent, true, true, false},
        {"VBK", "masternodedebug", &masternodedebug, true, true, false},
        {"VBK", "startmasternode", &startmasternode, true, true, false},
        {"VBK", "createmasternodekey", &createmasternodekey, true, true, false},
        {"VBK", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"VBK", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"VBK", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"VBK", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"VBK", "getmasternodescores", &getmasternodescores, true, true, false},
        {"VBK", "mnbudget", &mnbudget, true, true, false},
        {"VBK", "preparebudget", &preparebudget, true, true, false},
        {"VBK", "submitbudget", &submitbudget, true, true, false},
        {"VBK", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"VBK", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"VBK", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"VBK", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"VBK", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"VBK", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"VBK", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"VBK", "checkbudgets", &checkbudgets, true, true, false},
        {"VBK", "mnsync", &mnsync, true, true, false},
        {"VBK", "spork", &spork, true, true, false},
        {"VBK", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"VBK", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use VBKd, or the -server option to VBK-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> VBK-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:22264/\n";
}
