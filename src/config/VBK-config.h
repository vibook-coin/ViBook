/* src/config/VBK-config.h.  Generated from VBK-config.h.in by configure.  */
/* src/config/VBK-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.VBK.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "VBK Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "VBK Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "VBK"
