Contributing to VBK Core
============================

The VBK Core project operates an open contributor model where anyone is
...
The following applies to code changes to the VBK Core project, and is not to be
confused with overall VBK Network Protocol consensus changes.

Whether a pull request is merged into VBK Core rests with the project merge
...
Patches that change VBK consensus rules are considerably more involved than
...
Where a patch set proposes to change the VBK consensus, it must have been
...
The project leader is the release manager for each VBK Core release.
