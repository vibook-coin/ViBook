...
In order to support loading of multiple wallets in VBK-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is VBK.cpp.
...
Changes to VBK.cpp
----------------------
VBK.cpp is the entry point into VBK-qt, and as such, will require some minor modifications to provide hooks for
