...
RESOURCES += src/qt/VBK.qrc src/qt/VBK_locale.qrc

TRANSLATIONS += src/qt/locale/VBK_bg.ts \
                src/qt/locale/VBK_de.ts \
                src/qt/locale/VBK_en.ts \
                src/qt/locale/VBK_es.ts \
                src/qt/locale/VBK_fi.ts \
                src/qt/locale/VBK_fr.ts \
                src/qt/locale/VBK_it.ts \
                src/qt/locale/VBK_ja.ts \
                src/qt/locale/VBK_pl.ts \
                src/qt/locale/VBK_pt.ts \
                src/qt/locale/VBK_ru.ts \
                src/qt/locale/VBK_sk.ts \
                src/qt/locale/VBK_sv.ts \
                src/qt/locale/VBK_vi.ts \
                src/qt/locale/VBK_zh_CN.ts \
                src/qt/locale/VBK_zh_TW.ts
